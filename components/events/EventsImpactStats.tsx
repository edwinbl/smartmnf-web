...
const stats = [
  { value: 14500, label: "Participants engaged", suffix: "+" },
  { value: 28, label: "Industries represented", suffix: "" },
  { value: 27, label: "States & UTs reached", suffix: "" },
  { value: 320, label: "Sessions conducted", suffix: "+" },
];
...
export const EventsImpactStats = () => (
  <section
    ...
    <div className="container-cii relative">
      <div className="max-w-2xl">
        ...
        <h2 className="font-display font-bold text-[28px] md:text-[36px] leading-tight tracking-tight">
          A national platform measured by the leaders it convenes
        </h2>
        <p className="mt-3 text-white/75 max-w-xl">
          Every event feeds into India's Industry 4.0 transformation â informing policy, accelerating MSMEs and connecting the ecosystem.
        </p>
      </div>
